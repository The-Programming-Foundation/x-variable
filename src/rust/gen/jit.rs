        ...
        match modrm_byte >> 3 & 7 {
            ...
            2 => {
                ...
                if modrm_byte < 0xC0 {
                    let addr = ::modrm::decode(ctx.cpu, modrm_byte);
                    ::codegen::gen_modrm_resolve(ctx, addr);
                    ::codegen::gen_modrm_fn0(ctx.builder, "instr_F6_2_mem");
                }
                else {
                    ::codegen::gen_fn1_const(ctx.builder, "instr_F6_2_reg", (modrm_byte & 7) as u32);
                }
                *instr_flags |= ::jit::JIT_INSTR_BLOCK_BOUNDARY_FLAG;
                ::codegen::gen_move_registers_from_memory_to_locals(ctx);
            },
            3 => {
                ...
                if modrm_byte < 0xC0 {
                    let addr = ::modrm::decode(ctx.cpu, modrm_byte);
                    ::codegen::gen_modrm_resolve(ctx, addr);
                    ::codegen::gen_modrm_fn0(ctx.builder, "instr_F6_3_mem");
                }
                else {
                    ::codegen::gen_fn1_const(ctx.builder, "instr_F6_3_reg", (modrm_byte & 7) as u32);
                }
                *instr_flags |= ::jit::JIT_INSTR_BLOCK_BOUNDARY_FLAG;
                ::codegen::gen_move_registers_from_memory_to_locals(ctx);
            },
